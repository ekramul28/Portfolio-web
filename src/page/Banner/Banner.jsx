...
const Banner = () => {
    return (
        <div className="md:h-[527px] md:flex  ">
            <div className="md:w-1/2 text-white md:mt-36 mx-5">
            ...
            <div className=" md:w-1/2">
                <img className="w-full h-full " src="https://i.ibb.co/tc9SMh3/Untitled-design-2.png" alt="" />
            </div>
        </div>
    );
};
